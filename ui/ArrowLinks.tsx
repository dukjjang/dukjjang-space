...
const ArrowLinks = ({
  ...
  const [play] = useSound("/sounds/arrow.mp3", {
    volume: sound === true ? 0.3 : 0,
  });
  return (
    <div className="flex justify-between items-center px-4 py-8 w-full ">
      ...
      >
        ...
        />
        <h6 className="group-hover:text-gradient ">prev</h6>
      </Link>
      ...
      >
        <h6 className="group-hover:text-gradient ">next</h6>
        <BsArrowRightShort
          size={30}
